...
.. image:: https://img.shields.io/github/issues/electux/abcomm.svg
   :target: https://github.com/electux/abcomm/issues
   :alt: GitHub issues open

.. image:: https://img.shields.io/github/contributors/electux/abcomm.svg
   :target: https://github.com/electux/abcomm/graphs/contributors
...
.. list-table:: microHIL Protocol Specification
   :widths: 25 35 40
   :header-rows: 1
...
Contributions are welcome! Please read `CONTRIBUTING.md <https://github.com/electux/abcomm/blob/main/CONTRIBUTING.md>`_ for development guidelines.

📄 License
==========

Copyright (C) 2026 by `electux.github.io/abcomm <https://github.com/electux>`_
